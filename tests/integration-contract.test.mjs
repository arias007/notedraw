...
test("3.2.11 preserves bottom coordinates and cross-view frames without eager hidden-view refresh", async () => {
  ...
  assert.equal(manifest.version, "3.2.11");
  assert.match(source, /version: "3\.2\.11"/);
