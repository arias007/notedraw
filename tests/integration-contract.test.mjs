...
test("3.3.26 preserves reading content and cross-view frames without hidden-surface layout writes", async () => {
  ...
  assert.equal(manifest.version, "3.3.26");
  assert.match(source, /version: "3\.3\.26"/);
