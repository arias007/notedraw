...
test("3.3.12 preserves bottom coordinates and cross-view frames without eager hidden-view refresh", async () => {
  ...
  assert.equal(manifest.version, "3.3.12");
  assert.match(source, /version: "3\.3\.12"/);
