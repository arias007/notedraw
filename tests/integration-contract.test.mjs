...
test("3.4.44 preserves reading content and cross-view frames without hidden-surface layout writes", async () => {
  ...
  assert.equal(manifest.version, "3.4.44");
...
test("selection tool previews and commits exact NoteFlow Markdown insertion targets", async () => {
  ...
  assert.match(finishSource, /requestedDropPlacement[\s\S]*this\.resolveDraggedNoteFlowPlacement[\s\S]*this\.snapDraggedSelectionToNoteFlowPlacement[\s\S]*preserveBoxGeometry:[\s\S]*this\.clearNoteFlowLayout\(\)/);
