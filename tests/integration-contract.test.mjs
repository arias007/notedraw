...
test("3.3.13 preserves bottom coordinates and cross-view frames without eager hidden-view refresh", async () => {
  ...
  assert.equal(manifest.version, "3.3.13");
  assert.match(source, /version: "3\.3\.13"/);
